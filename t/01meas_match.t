...
my $hts = [ { measurement_time => '2015-04-01T11:42:14',
...
my $wt = { measurement_time => '2015-09-05T14:42:10',
	   measurement_concept_id => 3013762,
	   value_as_number => 25 };

my $ts = $handle->create_time_series( $hts );
eq_or_diff( [ map { $_->{meas} } @$ts ],
	    [ sort { $a->{measurement_time} cmp $b->{measurement_time} } @$hts ],
	    'Time series order');
...
$wt->{measurement_time} = '2015-01-10T11:42:14';
